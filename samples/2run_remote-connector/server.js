...
const quizTitle = process.env.QUIZ_TITLE || "Remote DB + Connector App";
const quiz = [
  {
    "id": "install",
...
const server = http.createServer(async (req, res) => {
  ...
  if (url.pathname === '/api/health') {
    ...
    res.end(JSON.stringify({ ok: true, name: "remote-connector", port }));
    return;
  }
