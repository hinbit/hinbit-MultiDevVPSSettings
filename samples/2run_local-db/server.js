...
const quizTitle = process.env.QUIZ_TITLE || "Local DB App";
const quiz = [
  {
    "id": "install",
...
const server = http.createServer(async (req, res) => {
  ...
  if (url.pathname === '/api/health') {
    ...
    res.end(JSON.stringify({ ok: true, name: "local-db", port }));
    return;
  }
