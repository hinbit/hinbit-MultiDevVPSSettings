...
const quizTitle = process.env.QUIZ_TITLE || "UI Control Service";
const quiz = [
  {
    "id": "install",
...
const server = http.createServer(async (req, res) => {
  ...
  if (url.pathname === '/api/health') {
    ...
    res.end(JSON.stringify({ ok: true, name: "ui-control", port }));
    return;
  }
