...
const VPS_CONTROL_ACTIONS = new Set(['communication-off', 'communication-on', 'process-start', 'process-stop', 'process-restart', 'node-suspend', 'node-resume', 'shutdown', 'wake', 'status']);
